...
from .core import TOOL_DEFINITIONS, ToolRegistry
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--cwd",
        default=str(runtime_settings.get("default_working_dir", Path.cwd())),
    ...
    parser.add_argument(
        "--log-level",
        default=str(runtime_settings.get("log_level", "INFO")),
